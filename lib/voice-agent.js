  ...
  getMicErrorMessage( error )
  {
    switch( error && error.name )
    {
      ...
      case 'OverconstrainedError':
        return "Can't access your microphone — no microphone was found on this device.";
      case 'NotReadableError':
        return "Can't access your microphone — it may be in use by another app.";
      default:
        return "Can't access your microphone. Please check your device and try again.";
    }
  }
